...
parser.add_argument("--wandb", type=str, default="online", help="Wandb mode (online/offline/disabled).")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    # configure wandb logging (same style as train_rlgames.py)
    if "agent" in agent_cfg and "experiment" in agent_cfg["agent"] and args_cli.wandb != "disabled":
