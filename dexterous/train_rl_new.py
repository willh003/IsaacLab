...
Run with allegro:
isaaclab train_allegro.py --task=Isaac-Repose-Cube-Allegro-v0
"""
...
parser.add_argument("--save_interval", type=int, default=500, help="RL Policy training iterations.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    agent_cfg.wandb_project = "dexterous"
    agent_cfg.wandb_entity = "willhu003"
    ...
    if args_cli.distributed:
        env_cfg.sim.device = f"cu da:{app_launcher.local_rank}"
